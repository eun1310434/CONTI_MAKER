...
public class GUI_down_landscape extends Activity {
	...
	public void NWGetScore(int _m_id){
		...
		if(screen.equals("Portrait")){
			...
			File f = new File(Environment.getExternalStorageDirectory().getAbsoluteFile()+"/contimaker/score/wc"+Integer.toString(_m_id)+".png");
			if(f.exists() == false){
			...
			File f = new File(Environment.getExternalStorageDirectory().getAbsoluteFile()+"/contimaker/score/wc"+Integer.toString(_m_id)+"_1.png");
			if(f.exists() == false){
    ...
    public Boolean ConnectionCheck(){
		...
		if(isWifiConn==false && isMobileConn==false)
		{
			...
			new AlertDialog.Builder(GUI_down_landscape.this)
			.setTitle("����!")
			.setMessage("���ͳ� ������ Ȯ���� �ּ���.")
			.setPositiveButton("��",
	...
	public void FinishFromGcmShare(){
		...
		if(screen.equals("Portrait")){
			...
			intent.setClass( GUI_down_landscape.this, GUI_music_view_share_control.class);
        	intent.putParcelableArrayListExtra("registrationIds", ListItem);
			intent.putExtra("m_id", m_id);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
			GUI_down_landscape.this.startActivity(intent);
			GUI_down_landscape.this.finish();
	...
	public void FinishFromGcmContiControl(){
		...
		if(screen.equals("Portrait")){
			...
			Intent intent = new Intent();
			intent.setClass( GUI_down_landscape.this, GUI_conti_view_share_control.class);
	...
	public void FinishFromGcmConti(){
		...
		if(screen.equals("Portrait")){
			...
			Intent intent = new Intent();
			intent.setClass( GUI_down_landscape.this, GUI_remote_view_portrait.class);
			...
			Intent intent = new Intent();
			intent.setClass( GUI_down_landscape.this, GUI_remote_view_landscape.class);
			intent.putExtra("sender", sender);
			intent.putExtra("getFrom", getFrom);
			intent.putExtra("m_id", cm_m_id);
			intent.putExtra("page", 1);
	...
	public void FinishFromGUI_music(){
		...
		if(screen.equals("Portrait")){
			...
			Intent intent = new Intent();
			intent.setClass( GUI_down_landscape.this, GUI_music_view_portrait.class);
			intent.putExtra("getFrom", getFrom);
			intent.putExtra("m_id", m_id);
			intent.putExtra("ItemSet", ItemSet);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
			...
			Intent intent = new Intent();
			intent.setClass( GUI_down_landscape.this, GUI_music_view_landscape.class);
			intent.putExtra("getFrom", getFrom);
			intent.putExtra("m_id", m_id);
			intent.putExtra("ItemSet", ItemSet);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
