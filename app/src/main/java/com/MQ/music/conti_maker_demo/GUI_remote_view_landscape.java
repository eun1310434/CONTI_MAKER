...
public class GUI_remote_view_landscape extends Activity implements  OnClickListener {
	...
	//Activity
	public static Activity GUI_remote_view_landscape_activity;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gui_remote_view_landscape);
		overridePendingTransition(0, 0);
		
		
		GUI_remote_view_landscape_activity = GUI_remote_view_landscape.this;//����� ���
	...
	public static void score_set( int  _m_id , int _page , String _m_name){
		...
		m_name = _m_name;
		TV_title.setText("[���� ����]"+sender+"-"+m_name);
		m_img = Environment.getExternalStorageDirectory()+"/contimaker/score/wc"+Integer.toString(m_id)+"_"+Integer.toString(page)+".png";
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.IB_m_img){
			...
			if(getFrom.equals("GUI_gcm_conti")){
				...
				Intent intent1 = new Intent(GUI_remote_view_landscape.this, GUI_down_portrait.class);
				intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				intent1.putExtra("getFrom", "GUI_gcm_conti");
				intent1.putExtra("sender",sender);
				intent1.putExtra("screen", "Portrait");
				intent1.putExtra("c_name",c_name);
				intent1.putExtra("ItemSet", "off");
				intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); 
				GUI_remote_view_landscape.this.finish();
				GUI_remote_view_landscape.this.startActivity(intent1);
				
			}else{
				
				File f = new File(Environment.getExternalStorageDirectory()+"/contimaker/score/wc"+Integer.toString(m_id)+".png");
				if(f.exists()){

					Intent intent = new Intent();
					intent.setClass( GUI_remote_view_landscape.this, GUI_remote_view_portrait.class);
					...
					GUI_remote_view_landscape.this.startActivity(intent);
					GUI_remote_view_landscape.this.finish();
			    	
			    }else{
			    	
					Intent intent = new Intent();
					intent.setClass( GUI_remote_view_landscape.this, GUI_down_landscape.class);
		...
		public static void Finish(){
			...
			GUI_remote_view_landscape aActivity = (GUI_remote_view_landscape) GUI_remote_view_landscape.GUI_remote_view_landscape_activity;
		...
		public boolean onKeyDown(int KeyCode, KeyEvent event) {
			...
			if (event.getAction() == KeyEvent.ACTION_DOWN) {
				...
				if (KeyCode == KeyEvent.KEYCODE_BACK) {
					...
					GUI_remote_view_landscape.Finish();
